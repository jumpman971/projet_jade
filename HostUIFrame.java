    ...
    extends JFrame
{
    ...
    Box box_buttons;
    JPanel pnl_numClients = new JPanel();
    BorderLayout borderLayout3 = new BorderLayout();
	BorderLayout borderLayout4 = new BorderLayout();
    JLabel lbl_numClients = new JLabel();
    Box box_numClients;
    JLabel lbl_clientCount = new JLabel();
    JSlider slide_numClients = new JSlider();
	
	JPanel pnl_numTaxis = new JPanel();
    JLabel lbl_numTaxis = new JLabel();
    Box box_numTaxis;
    JLabel lbl_taxiCount = new JLabel();
    JSlider slide_numTaxis = new JSlider();
    ...
    protected NuberHost m_owner;


    // Constructors
    //////////////////////////////////

    public HostUIFrame( NuberHost owner ) {
        try {
            jbInit();
        }
        catch(Exception e) {
    ...
    private void jbInit() throws Exception {
		...
		box_numTaxis = Box.createHorizontalBox();
        ...
        pnl_numClients.setLayout(borderLayout3);
        lbl_numClients.setText("No. of clients:");
        lbl_clientCount.setMaximumSize(new Dimension(30, 17));
        lbl_clientCount.setMinimumSize(new Dimension(30, 17));
        lbl_clientCount.setPreferredSize(new Dimension(30, 17));
        lbl_clientCount.setText("10");
        slide_numClients.setValue(10);
        slide_numClients.setMaximum(1000);
        slide_numClients.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                slide_numClients_stateChanged(e);
            }
        });
		pnl_numTaxis.setLayout(borderLayout4);
        lbl_numTaxis.setText("No. of taxis:");
        lbl_taxiCount.setMaximumSize(new Dimension(30, 17));
        lbl_taxiCount.setMinimumSize(new Dimension(30, 17));
        lbl_taxiCount.setPreferredSize(new Dimension(30, 17));
        lbl_taxiCount.setText("10");
        slide_numTaxis.setValue(10);
        slide_numTaxis.setMaximum(1000);
        slide_numTaxis.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                slide_numTaxis_stateChanged(e);
            }
        });
        ...
        this.getContentPane().add(pnl_numClients, BorderLayout.NORTH);
        pnl_numClients.add(box_numClients, BorderLayout.CENTER);
        pnl_numClients.setBorder( BorderFactory.createCompoundBorder( BorderFactory.createEtchedBorder(), BorderFactory.createEmptyBorder( 2, 2, 2, 2 ) ) );

        box_numClients.add(lbl_numClients, null);
        box_numClients.add(slide_numClients, null);
        box_numClients.add(lbl_clientCount, null);
		
		
		this.getContentPane().add(pnl_numTaxis, BorderLayout.CENTER);
        pnl_numTaxis.add(box_numTaxis, BorderLayout.CENTER);
        pnl_numTaxis.setBorder( BorderFactory.createCompoundBorder( BorderFactory.createEtchedBorder(), BorderFactory.createEmptyBorder( 2, 2, 2, 2 ) ) );

        box_numTaxis.add(lbl_numTaxis, null);
        box_numTaxis.add(slide_numTaxis, null);
        box_numTaxis.add(lbl_taxiCount, null);
    ...
    /**
     * When the slider for the num clients changes, we update the label.
     */
    void slide_numClients_stateChanged(ChangeEvent e) {
        lbl_clientCount.setText( Integer.toString( slide_numClients.getValue() ) );
    }
	
	/**
     * When the slider for the num clients changes, we update the label.
     */
    void slide_numTaxis_stateChanged(ChangeEvent e) {
        lbl_taxiCount.setText( Integer.toString( slide_numTaxis.getValue() ) );
    }
    ...
    void btn_start_actionPerformed(ActionEvent e) {
        ...
        m_owner.addBehaviour( new OneShotBehaviour() {
                                  public void action() {
                                      ((NuberHost) myAgent).invite( slide_numClients.getValue(),  slide_numTaxis.getValue());
                                  }
                              } );
    }
    ...
    void btn_Exit_actionPerformed(ActionEvent e) {
        m_owner.addBehaviour( new OneShotBehaviour() {
                                  public void action() {
                                      ((NuberHost) myAgent).terminateHost();
                                  }
                              } );
    }
